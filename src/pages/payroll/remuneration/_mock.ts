...
import type { RemunerationItem, Params } from './data.d';

// mock - generate withdrawal list
const genList = (current: number, pageSize: number) => {
  const tableListDataSource: RemunerationItem[] = [];
...
function getRemunerations(req: Request, res: Response, u: string) {
  let realUrl = u;
...
export default {
  'GET /api/remunerations': getRemunerations,
};
